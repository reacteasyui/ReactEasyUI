;(function(window) {
  ...
  var svgSprite = '<svg>' +
    ...
    '' +
    '<path d="M960 64h-896c-26.528 0-48 21.472-48 48v640c0 26.496 21.472 48 48 48h304v80l-64 64v16h416v-16l-64-64v-80h304c26.496 0 48-21.504 48-48v-640c0-26.528-21.504-48-48-48zM944 672h-864v-544h864v544z" fill="" ></path>' +
    '' +
    '</symbol>' +
    '' +
    '<symbol id="icon-mobile" viewBox="0 0 1024 1024">' +
    '' +
    '<path d="M665.348 14.659h-306.709c-50.078 0-84.487 33.75-84.487 82.902v828.879c0 49.095 34.409 82.902 84.487 82.902h306.709c50.078 0 84.515-33.806 84.515-82.902v-828.865c0-49.152-34.437-82.902-84.515-82.902zM465.036 88.345h90.771v18.404h-90.757v-18.404zM512 981.679c-21.911 0-37.551-15.332-37.551-36.822s15.643-36.822 37.551-36.822 37.566 15.332 37.566 36.822-15.655 36.822-37.566 36.822zM718.553 877.316h-409.993v-727.601h409.993v727.601z" fill="#333333" ></path>' +
    '' +
    '</symbol>' +
    '' +
