;(function(window) {
  ...
  var svgSprite = '<svg>' +
    '' +
    '<symbol id="icon-pc" viewBox="0 0 1000 1000">' +
    '' +
    '<path d="M893.305 101.184h-787.5c-23.316 0-42.188 18.872-42.188 42.188v562.5c0 23.287 18.872 42.188 42.188 42.188h267.188v70.313l-56.25 56.25v14.063h365.625v-14.063l-56.25-56.25v-70.313h267.188c23.287 0 42.188-18.9 42.188-42.188v-562.5c0-23.316-18.9-42.188-42.188-42.188zM879.243 635.559h-759.375v-478.125h759.375v478.125z" fill="" ></path>' +
    '' +
    '</symbol>' +
    '' +
    '<symbol id="icon-mobile" viewBox="0 0 1024 1024">' +
    '' +
    '<path d="M665.348 9.326h-306.709c-50.078 0-84.487 33.75-84.487 82.902v828.879c0 49.095 34.409 82.902 84.487 82.902h306.709c50.078 0 84.515-33.806 84.515-82.902v-828.865c0-49.152-34.437-82.902-84.515-82.902zM465.036 83.012h90.771v18.404h-90.757v-18.404zM512 976.346c-21.911 0-37.551-15.332-37.551-36.822s15.643-36.822 37.551-36.822 37.566 15.332 37.566 36.822-15.655 36.822-37.566 36.822zM718.553 871.983h-409.993v-727.601h409.993v727.601z" fill="#333333" ></path>' +
    '' +
    '</symbol>' +
    '' +
